...
public class ProjectService(
  ...
  public async Task<Project?> CreateNewProjectAsync(string name) {
    ...
    AccessControl accessControl = new AccessControl {
      ReadAccess = true, WriteAccess = true,   Manage = true,
      Owner = true,      Project = newProject, ApplicationUser = user,
    };
  ...
  public async Task AddUserToProjectAsync(long ProjectId, bool Read = true,
    ...
    AccessControl accessControl = new AccessControl {
      ReadAccess = Read, WriteAccess = Write, Manage = Manage,
      Owner = Owner,     Project = project,   ApplicationUser = user,
    };
  ...
  public async Task<string?> InviteMemberByEmailAsync(long projectId,
    ...
    AccessControl accessControl = new AccessControl {
      ReadAccess = read, WriteAccess = write, Manage = manage,
      Owner = false,     Project = project,   ApplicationUser = targetUser,
    };
